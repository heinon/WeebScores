...
{
    /// <inheritdoc />
    public partial class InitialAnime : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EpisodeNumber = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Genres", x => new { x.AnimeId, x.Id });
                    table.ForeignKey(
